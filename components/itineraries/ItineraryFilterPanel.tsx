...
const DURATIONS = ["Weekend (1 – 2 Days)", "3 – 5 Days", "6 – 9 Days", "10+ Days"];

export default function ItineraryFilterPanel() {
    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center justify-between">
                <h2 className="text-base font-bold text-gray-900">Filter Itineraries</h2>
                <div className="flex items-center gap-2">
                    <HugeiconsIcon icon={FilterHorizontalIcon} size={18} strokeWidth={1.8} className="text-gray-400 hidden lg:block" />
                    <button
                        onClick={() => setIsOpen((p) => !p)}
                        className="lg:hidden flex items-center gap-1.5 text-xs font-semibold text-purple-600 border border-purple-200 bg-purple-50 rounded-full px-3 py-1 hover:bg-purple-100 transition-colors"
                    >
            ...
            <div className={`flex-col gap-5 ${isOpen ? "flex" : "hidden"} lg:flex`}>
                ...
                {/* Search */}
                <div>
                    <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Search itinerary</p>
                ...
                {/* Duration */}
                <div>
                    <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2.5">Duration</p>
